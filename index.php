...
<section class="main" >
  <div class="container">
   <p class="text-utama">Masjid Besar SMK Wikrama Bogor</p>
   <h1 class="black-text">Mari <span>Tingkatkan</span> <br> <span>Keimanan </span>Masyarakat <br> SMK Wikrama Bogor. </h1>
  </div>  
  <div class="image">
  ...
  <div class="card-container">
    <div class="card3">
      <img src="img/" alt="Logo" class="card-logo">
      <div class="card-description">
          <h3 class="card-title">Al-Qur'an Gratis.</h3>
     </div>
  </div>
</div>
<div class="card-ball">
  <img src="img/logowikrama.png" alt="Logo" class="card-logos">
</div>
